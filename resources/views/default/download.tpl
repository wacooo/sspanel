        ...
        <div class="row">
            <div class="col s12 m4">
                ...
                <ul>
                    <li>shadowsocks-win:
                        <ul>
                            <li>Windows 7 or above: <a href="https://github.com/shadowsocks/shadowsocks-csharp/releases/download/2.5.6/Shadowsocks-win-2.5.6.zip">2.5.6.zip</a></li>
                        </ul>
                    </li>
                    <li>Shadowsocks-Qt5:
                        <ul>
                            <li><a href="https://github.com/shadowsocks/shadowsocks-qt5/releases">Latest release</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            <div class="col s12 m4">
                <h5><i class="fa fa-apple fa-3x"></i> &nbsp; Mac OS X</h5><p><strong>GUI Client</strong></p><ul><li>ShadowsocksX: <a href="https://github.com/shadowsocks/shadowsocks-iOS/releases/download/2.6.3/ShadowsocksX-2.6.3.dmg">2.6.3.dmg</a></li><li>GoAgentX: <a href="https://goagentx.googlecode.com/files/GoAgentX-v2.2.9.dmg">v2.2.9.dmg</a></li></ul><p><strong>Command-line Client</strong></p><ul><li><code>brew install shadowsocks-libev</code></li></ul>
            </div>

            <div class="col s12 m4">
                <h5><i class="fa fa-linux fa-3x"></i> &nbsp; Linux</h5><p><strong>GUI Client</strong></p><ul><li>Shadowsocks-Qt5:<ul><li><a href="https://github.com/shadowsocks/shadowsocks-qt5/wiki/Installation">Latest release</a></li></ul></li></ul><p><strong>Command-line Client</strong></p><ul><li>shadowsocks-python:<ul><li><code>pip install shadowsocks</code></li></ul></li></ul>
            </div>
